...
const projects = [
  ...
  },
  {
    ...
    {
    title: 'AI4Justice',
    description: 'A production website built as Frontend Engineer for AI4Justice — a platform promoting justice through artificial intelligence. Live on Microsoft Azure.',
    image: '',
    tags: ['Frontend', 'Azure', 'Production', 'Team Project'],
